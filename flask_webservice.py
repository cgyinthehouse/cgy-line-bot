...
# http://127.0.0.1:5000/fun1?userInput=你好
# http://127.0.0.1:5000/fun1?userInput=健行科技大學的ubike
# http://127.0.0.1:5000/fun1?userInput=健行科技大學的ubike&format=json
...
@app.route('/', methods=['GET', 'POST'])  # 主畫面
def index():
